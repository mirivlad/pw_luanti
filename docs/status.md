...
| A town can be sited on a shoal | Site selection measures buildability but a shallow flooded shelf reads as buildable ground | Scorchmarket's houses stand on a platform in shallow water. The wall no longer follows them out to sea, but the town is still in it |
